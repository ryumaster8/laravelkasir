...
use App\Http\Middleware\CheckRetailAccess;
...
class Kernel extends HttpKernel
{
    ...
    protected $middlewareGroups = [
        ...
        'api' => [
            // Enable Sanctum middleware if using token authentication
    ...
    protected $middlewareAliases = [
        ...
        'check.retail' => CheckRetailAccess::class,
        'check.retail.type' => CheckRetailType::class,
