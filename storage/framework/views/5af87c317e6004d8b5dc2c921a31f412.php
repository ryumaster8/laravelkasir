        ...
        <div class="p-6">
            ...
            <div class="bg-blue-50 p-6 rounded-lg">
                <div class="flex items-center justify-between mb-4">
                    <div>
                        <span class="text-xl font-semibold text-blue-900"><?php echo e($outlet->membership->membership_name); ?></span>
                        <p class="text-blue-600 mt-1">
                            Rp <?php echo e(number_format($outlet->membership->biaya_bulanan, 0, ',', '.')); ?>/bulan
                        </p>
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                    <div class="bg-white p-4 rounded-lg shadow-sm">
                        ...
                        <p class="text-lg font-semibold">
                            <?php echo e($outlet->membership->branch_limit); ?> / <?php echo e($outlet->branch_count); ?>
                        ...
                        <div class="mt-2 h-2 bg-gray-200 rounded-full overflow-hidden">
                            <div class="h-full bg-blue-600 rounded-full" 
                                 style="width: <?php echo e(min($branchPercent, 100)); ?>%">
                            </div>
                        </div>
                        <?php if($branchPercent >= 80): ?>
                    ...
                    <div class="bg-white p-4 rounded-lg shadow-sm">
                        ...
                        <p class="text-lg font-semibold">
                            <?php echo e($outlet->membership->user_limit); ?> / 
                            <?php echo e(App\Models\ModelUser::getOutletGroupUserCount($outlet->outlet_group_id)); ?>
                        ...
                        <div class="mt-2 h-2 bg-gray-200 rounded-full overflow-hidden">
                            <div class="h-full bg-blue-600 rounded-full" 
                                 style="width: <?php echo e(min($userPercent, 100)); ?>%">
                            </div>
                        </div>
                        <?php if($userPercent >= 80): ?>
                            <p class="text-xs text-yellow-600 mt-1">
                                Mendekati batas maksimal
                            </p>
                        <?php endif; ?>
                    ...
                    <div class="bg-white p-4 rounded-lg shadow-sm">
                        ...
                        <p class="text-lg font-semibold">
                            <?php echo e($outlet->membership->daily_transaction_limit); ?> / 
                            <?php echo e(\App\Models\ModelTransaction::getTodayTransactionCount($outlet->outlet_group_id)); ?>
                        ...
                        <div class="mt-2 h-2 bg-gray-200 rounded-full overflow-hidden">
                            <div class="h-full bg-blue-600 rounded-full" 
                                 style="width: <?php echo e(min($transactionPercent, 100)); ?>%">
                            </div>
                        </div>
                        <?php if($transactionPercent >= 80): ?>
                            <p class="text-xs text-yellow-600 mt-1">
                                Mendekati batas maksimal
                            </p>
                        <?php endif; ?>
                    ...
                    <div class="bg-white p-4 rounded-lg shadow-sm">
                        ...
                        <p class="text-lg font-semibold">
                            <?php echo e($outlet->membership->daily_product_addition_limit); ?> / 
                            <?php echo e(\App\Models\ModelProduct::getTodayProductCount($outlet->outlet_group_id)); ?>
                        ...
                        <div class="mt-2 h-2 bg-gray-200 rounded-full overflow-hidden">
                            <div class="h-full bg-blue-600 rounded-full" 
                                 style="width: <?php echo e(min($productPercent, 100)); ?>%">
                            </div>
                        </div>
                        <?php if($productPercent >= 80): ?>
                            <p class="text-xs text-yellow-600 mt-1">
                                Mendekati batas maksimal
                            </p>
                        <?php endif; ?>
                    ...
                    <div>
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="flex items-center text-sm">
                                ...
                                <?php endif; ?>
                                <span class="<?php echo e($outlet->membership->$key ? 'text-gray-900' : 'text-gray-400'); ?>">
                                    <?php echo e($label); ?>
            ...
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-yellow-700">
                        Anda telah mengajukan <?php echo e($pendingRequest->change_type === 'upgrade' ? 'upgrade' : 'downgrade'); ?> 
                        ke paket <?php echo e($pendingRequest->requestedMembership->membership_name); ?>.
                    </p>
                    <div class="mt-2 space-y-1">
                        <p class="text-sm text-yellow-600">
                            Status Perubahan: 
                            <span class="font-semibold">
                                <?php switch($pendingRequest->change_status):
                                    ...
                                    <?php case ('completed'): ?>
                                        ...
                                        <?php break; ?>
                                    <?php default: ?>
                                        <?php echo e(ucfirst($pendingRequest->change_status)); ?>
                        ...
                        <p class="text-sm text-yellow-600">
                            Status Pembayaran: 
                            <span class="font-semibold">
                                <?php switch($pendingRequest->payment_status):
                                    case ('unpaid'): ?>
                                        Belum Dibayar
                                        <?php break; ?>
                                    <?php case ('paid'): ?>
                        ...
                        <p class="text-sm text-yellow-600">
                            Biaya: Rp <?php echo e(number_format($pendingRequest->change_fee, 0, ',', '.')); ?>
        ...
        <div class="mb-6">
            ...
            <div id="upgrade-content" class="tab-content">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <?php $__currentLoopData = $upgradeMemberships; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $membership): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="bg-white rounded-lg shadow overflow-hidden">
                        <div class="p-6">
                            <h3 class="text-lg font-medium text-gray-900 mb-4"><?php echo e($membership->membership_name); ?></h3>
                            <div class="space-y-3 mb-6">
                                ...
                                <div class="flex items-center text-sm">
                                    ...
                                    <span><?php echo e($membership->branch_limit); ?> Cabang</span>
                                </div>
                                <div class="flex items-center text-sm">
                                    <svg class="w-4 h-4 text-green-500 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/>
                                    </svg>
                                    <span><?php echo e($membership->user_limit); ?> User</span>
                                </div>
                                <div class="flex items-center text-sm">
                                    <svg class="w-4 h-4 text-green-500 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/>
                                    </svg>
                                    <span><?php echo e($membership->daily_transaction_limit); ?> Transaksi/hari</span>
                                </div>
                                <div class="flex items-center text-sm">
                                    <svg class="w-4 h-4 text-green-500 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/>
                                    </svg>
                                    <span><?php echo e($membership->daily_product_addition_limit); ?> Produk/hari</span>
                                </div>
                                ...
                                <div class="space-y-2">
                                    ...
                                    <div class="flex items-center text-sm">
                                        ...
                                        <?php endif; ?>
                                        <span class="<?php echo e($membership->$key ? 'text-gray-900' : 'text-gray-400'); ?>"><?php echo e($label); ?></span>
                                    </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </div>
                                ...
                                <div class="flex flex-col gap-1 mb-4">
                                    <div>
                                        <span class="text-3xl font-bold text-gray-900">
                                            Rp <?php echo e(number_format($membership->biaya_bulanan, 0, ',', '.')); ?>
                                    ...
                                    <div class="text-sm">
                                        ...
                                        <span class="font-semibold text-indigo-600"> 
                                            Rp <?php echo e(number_format($membership->biaya_upgrade, 0, ',', '.')); ?>

                                        </span>
                                    </div>
                                </div>
                                
                                <form action="<?php echo e(route('outlet.request-upgrade')); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
                                    <input type="hidden" name="membership_id" value="<?php echo e($membership->membership_id); ?>">
            ...
            <div id="downgrade-content" class="tab-content hidden">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <?php $__currentLoopData = $downgradeMemberships; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $membership): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="bg-white rounded-lg shadow overflow-hidden">
                        <div class="p-6">
                            <h3 class="text-lg font-medium text-gray-900 mb-4"><?php echo e($membership->membership_name); ?></h3>
                            <div class="space-y-3 mb-6">
                            ...
                            <div class="border-t border-gray-200 pt-4">
                                <div class="flex flex-col gap-1 mb-4">
                                    ...
                                    <div class="text-sm">
                                        ...
                                        <span class="font-semibold text-red-600"> 
                                            Rp <?php echo e(number_format($membership->biaya_downgrade, 0, ',', '.')); ?>
                                ...
                                <button 
                                    onclick="confirmDowngrade(<?php echo e($membership->membership_id); ?>, <?php echo e($membership->biaya_downgrade); ?>, '<?php echo e($membership->membership_name); ?>')"
            ...
            <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
                <div class="mt-3 text-center">
                    ...
                    <div class="flex justify-center gap-4 mt-4">
                        <form id="downgradeForm" action="<?php echo e(route('outlet.request-downgrade')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravelkasir\resources\views/outlet/change-membership.blade.php ENDPATH**/ ?>