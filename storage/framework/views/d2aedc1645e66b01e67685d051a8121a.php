    ...
    <div class="bg-white rounded-lg shadow-lg p-6">
        ...
        <div class="space-y-4" id="sessionItems">
            <?php if(count($sessions) > 0): ?>
                <?php $i = 1; ?>
                <?php $__currentLoopData = $sessions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="session-item bg-gray-50 rounded-lg p-4 hover:bg-gray-100 transition duration-150" data-key="<?php echo e(strtolower($key)); ?>">
                        <div class="flex items-start">
                            ...
                            <!-- Konten -->
                            <div class="flex-grow">
                                <strong class="text-gray-700 font-medium"><?php echo e($key); ?></strong>
                                <div class="mt-2">
                                    <?php if(is_array($value) || is_object($value)): ?>
                                        <pre class="bg-gray-800 text-green-400 rounded-md p-4 overflow-x-auto text-sm">
                                            <?php echo e(json_encode($value, JSON_PRETTY_PRINT)); ?>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravelkasir\resources\views/session/show.blade.php ENDPATH**/ ?>