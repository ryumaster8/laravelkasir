<!-- Sidebar -->
                ...
                <nav class="mt-4">
                    <ul class="space-y-1">
                        ...
                        <li class="menu-item">
                            ...
                            <ul class="submenu ml-6 mt-1 space-y-1 hidden">
                                <li><a href="/activity-logs" class="block px-4 py-2 text-sm text-gray-400 hover:bg-gray-700 hover:text-white rounded-lg">Tampilkan Log Aktivitas</a></li>
                            </ul>
                        </li>
        ...
        </aside><?php /**PATH C:\xampp\htdocs\laravelkasir\resources\views/partials/sidebar_owner.blade.php ENDPATH**/ ?>