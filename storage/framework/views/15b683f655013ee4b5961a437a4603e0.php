            ...
            <div class="col-md-4">
                <div class="card bg-dark membership-card h-100">
                    <div class="card-header text-center border-bottom border-light border-opacity-25">
                        <h3 class="membership-title mb-0"><?php echo e($membership->membership_name); ?></h3>
                    </div>
                    <div class="card-body">
                        <div class="price-tag text-center mb-4">
                            <h4 class="text-primary mb-2">Rp <?php echo e(number_format($membership->biaya_bulanan, 0, ',', '.')); ?></h4>
                            <span class="text-muted">per bulan</span>
                        </div>
                        <ul class="feature-list list-unstyled">
                            <li class="mb-2">
                                <i class="fas fa-check-circle text-success me-2"></i>
                                <?php echo e($membership->branch_limit); ?> Cabang
                            </li>
                            <?php if($membership->service_feature): ?>
                            <li class="mb-2">
                                <i class="fas fa-check-circle text-success me-2"></i>
                                Fitur Layanan Service
                            </li>
                            <?php endif; ?>
                            <?php if($membership->product_image_feature): ?>
                            <li class="mb-2">
                                <i class="fas fa-check-circle text-success me-2"></i>
                                Gambar Produk
                            </li>
                            <?php endif; ?>
                            <?php if($membership->discount_feature): ?>
                            <li class="mb-2">
                                <i class="fas fa-check-circle text-success me-2"></i>
                                Fitur Diskon
                            </li>
                            <?php endif; ?>
                            <?php if($membership->stock_correction_feature): ?>
                            <li class="mb-2">
                                <i class="fas fa-check-circle text-success me-2"></i>
                                Koreksi Stok
                            </li>
