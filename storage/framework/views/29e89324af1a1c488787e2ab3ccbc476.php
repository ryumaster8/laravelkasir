<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                ...
                <li class="nav-item">
        <a href="<?php echo e(route('tampilkan-semua-session')); ?>" class="nav-link">
    ...
    <!-- /.sidebar -->
</aside><?php /**PATH C:\xampp\htdocs\laravelkasir\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>