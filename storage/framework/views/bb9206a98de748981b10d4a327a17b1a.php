...
<?php endif; ?>
        ...
        <div class="mb-6 space-x-4">
            <a href="<?php echo e(route('teknisi.create')); ?>" class="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700">Tambah Teknisi</a>
            <?php if(optional(auth()->user())->role->role_name === 'superadmin'): ?>
                <a href="<?php echo e(route('teknisi.semua')); ?>" class="inline-flex items-center px-4 py-2 bg-gray-600 text-white rounded-lg hover:bg-gray-700">Lihat Semua Teknisi</a>
            <?php endif; ?>
        </div>
        ...
        <div class="overflow-x-auto shadow-md rounded-lg">
            <table id="teknisiTable" class="min-w-full table-auto">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <?php else: ?>
                        <?php $__currentLoopData = $teknisi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="hover:bg-gray-50">
                                <td class="px-6 py-4 whitespace-nowrap"><?php echo e($key + 1); ?></td>
                                <td class="px-6 py-4 whitespace-nowrap"><?php echo e($item->operator->username ?? 'N/A'); ?></td>
                                <td class="px-6 py-4 whitespace-nowrap"><?php echo e($item->outlet->outlet_name ?? 'N/A'); ?></td>
                                <td class="px-6 py-4 whitespace-nowrap"><?php echo e($item->nama_teknisi); ?></td>
                                <td class="px-6 py-4 whitespace-nowrap"><?php echo e($item->kontak); ?></td>
                                <td class="px-6 py-4 whitespace-nowrap"><?php echo e($item->status); ?></td>
                                <td class="px-6 py-4 whitespace-nowrap space-x-2">
                                    <a href="<?php echo e(route('teknisi.edit', $item->teknisi_id)); ?>" 
                                       class="inline-flex items-center px-3 py-1 bg-blue-600 text-white text-sm rounded-md hover:bg-blue-700">
                                        Edit
                                    </a>
                                    <form action="<?php echo e(route('teknisi.destroy', $item->teknisi_id)); ?>" method="POST" class="inline">
                                        <?php echo csrf_field(); ?>
                                        <?php echo method_field('DELETE'); ?>
                                        <button type="submit" 
                                                class="inline-flex items-center px-3 py-1 bg-red-600 text-white text-sm rounded-md hover:bg-red-700"
                                                onclick="return confirm('Apakah Anda yakin ingin menghapus data teknisi <?php echo e($item->nama_teknisi); ?>?')">
                                            Delete
                                        </button>
                                    </form>
                                    <a href="<?php echo e(route('teknisi.pindahcabang', $item->teknisi_id)); ?>" 
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravelkasir\resources\views/admin/teknisi/index.blade.php ENDPATH**/ ?>