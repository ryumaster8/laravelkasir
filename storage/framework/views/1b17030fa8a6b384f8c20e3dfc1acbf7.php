...
<?php endif; ?>
        ...
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100">
            ...
            <div class="p-8">
                <form action="<?php echo e(route('teknisi.store')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                        ...
                        <div class="col-span-1">
                            ...
                            <div class="relative">
                                ...
                                <input type="text" 
                                    ...
                                    id="operator_id"
                                    value="<?php echo e(old('operatorName', $operatorName ?? '')); ?>"
                                    readonly>
                        ...
                        <div class="col-span-1">
                            ...
                            <div class="relative">
                                ...
                                <input type="text"
                                    ...
                                    value="<?php echo e(old('outletName', $outletName ?? '')); ?>"
                                    readonly>
                                <input type="hidden" name="teknisi_outlet_id" value="<?php echo e(auth()->user()->outlet->outlet_id ?? ''); ?>">
                            </div>
                            <?php $__errorArgs = ['teknisi_outlet_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                        ...
                        <div class="col-span-1">
                            ...
                            <div class="relative">
                                ...
                                <input type="text"
                                    ...
                                    id="nama_teknisi"
                                    name="nama_teknisi"
                                    value="<?php echo e(old('nama_teknisi')); ?>"
                                    placeholder="Masukkan nama teknisi"
                                    required>
                            </div>
                            <?php $__errorArgs = ['nama_teknisi'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravelkasir\resources\views/admin/teknisi/create.blade.php ENDPATH**/ ?>