...
<div class="container">
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="text-dark">Tambah Izin Pengguna</h3>
        </div>
        <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                           <h6 class="fw-bold text-primary">Supplier</h6>
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input" name="can_add_supplier" id="can_add_supplier" value="1">
                                <label for="can_add_supplier" class="form-check-label">Bisa Tambah Supplier</label>
                            </div>
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input" name="can_edit_supplier" id="can_edit_supplier" value="1">
                                <label for="can_edit_supplier" class="form-check-label">Bisa Edit Supplier</label>
                            </div>
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input" name="can_delete_supplier" id="can_delete_supplier" value="1">
                            ...
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input" name="can_add_category" id="can_add_category" value="1">
                                <label for="can_add_category" class="form-check-label">Bisa Tambah Kategori</label>
                            </div>
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input" name="can_edit_category" id="can_edit_category" value="1">
                                <label for="can_edit_category" class="form-check-label">Bisa Edit Kategori</label>
                            </div>
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input" name="can_delete_category" id="can_delete_category" value="1">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input" name="can_add_product" id="can_add_product" value="1">
                                <label for="can_add_product" class="form-check-label">Bisa Tambah Produk</label>
                            </div>
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input" name="can_edit_product" id="can_edit_product" value="1">
                                <label for="can_edit_product" class="form-check-label">Bisa Edit Produk</label>
                            </div>
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input" name="can_delete_product" id="can_delete_product" value="1">
                            ...
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input" name="can_add_user" id="can_add_user" value="1">
                                <label for="can_add_user" class="form-check-label">Bisa Tambah Pengguna</label>
                            </div>
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input" name="can_edit_user" id="can_edit_user" value="1">
                                <label for="can_edit_user" class="form-check-label">Bisa Edit Pengguna</label>
                            </div>
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input" name="can_delete_user" id="can_delete_user" value="1">
                        ...
                        <div class="col-md-3">
                           <h6 class="fw-bold text-danger">Lokasi Produk</h6>
                             <div class="form-check">
                                <input type="checkbox" class="form-check-input" name="can_add_product_location" id="can_add_product_location" value="1">
                                <label for="can_add_product_location" class="form-check-label">Bisa Tambah Lokasi Produk</label>
                            </div>
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input" name="can_edit_product_location" id="can_edit_product_location" value="1">
                                <label for="can_edit_product_location" class="form-check-label">Bisa Edit Lokasi Produk</label>
                            </div>
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input" name="can_delete_product_location" id="can_delete_product_location" value="1">
                           ...
                           <h6 class="fw-bold text-secondary mt-3">Harga</h6>
                             <div class="form-check">
                                <input type="checkbox" class="form-check-input" name="can_see_cost_price" id="can_see_cost_price" value="1">
                                <label for="can_see_cost_price" class="form-check-label">Bisa Lihat Harga Modal</label>
                            </div>
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input" name="can_see_sale_price" id="can_see_sale_price" value="1">
                       ...
                       <div class="col-md-3">
                            ...
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input" name="can_see_supplier" id="can_see_supplier" value="1">
                                <label for="can_see_supplier" class="form-check-label">Bisa Lihat Supplier</label>
                            </div>
                             <div class="form-check">
                                 <input type="checkbox" class="form-check-input" name="can_see_category" id="can_see_category" value="1">
                                <label for="can_see_category" class="form-check-label">Bisa Lihat Kategori</label>
                            </div>
                             <div class="form-check">
                                   <input type="checkbox" class="form-check-input" name="can_see_operator" id="can_see_operator" value="1">
                                <label for="can_see_operator" class="form-check-label">Bisa Lihat Operator</label>
                            </div>
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input" name="can_see_outlet" id="can_see_outlet" value="1">
                                <label for="can_see_outlet" class="form-check-label">Bisa Lihat Outlet</label>
                            </div>
                             <div class="form-check">
                                   <input type="checkbox" class="form-check-input" name="can_see_stock" id="can_see_stock" value="1">
                                <label for="can_see_stock" class="form-check-label">Bisa Lihat Stok</label>
                            </div>
                             <div class="form-check">
                                  <input type="checkbox" class="form-check-input" name="can_see_brand" id="can_see_brand" value="1">
                                <label for="can_see_brand" class="form-check-label">Bisa Lihat Brand</label>
                            </div>
                              <div class="form-check">
                                   <input type="checkbox" class="form-check-input" name="can_see_product_location" id="can_see_product_location" value="1">
                                <label for="can_see_product_location" class="form-check-label">Bisa Lihat Lokasi Produk</label>
                            </div>
                            <div class="form-check">
                                   <input type="checkbox" class="form-check-input" name="can_see_barcode" id="can_see_barcode" value="1">
                                <label for="can_see_barcode" class="form-check-label">Bisa Lihat Barcode</label>
                            </div>
                            <div class="form-check">
                                 <input type="checkbox" class="form-check-input" name="can_see_unit_barcode" id="can_see_unit_barcode" value="1">
                                <label for="can_see_unit_barcode" class="form-check-label">Bisa Lihat Barcode Unit</label>
                            </div>
                             <div class="form-check">
                                <input type="checkbox" class="form-check-input" name="can_see_product_id" id="can_see_product_id" value="1">
