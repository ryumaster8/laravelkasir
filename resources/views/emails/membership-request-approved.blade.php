        ...
        <div class="content">
            ...
            <table class="details-table">
                <tr>
                    ...
                    <td>{{ $membershipRequest->currentMembership->membership_name }}</td>
                </tr>
                <tr>
                ...
                <tr>
                    <th>Biaya {{ ucfirst($membershipRequest->change_type) }}</th>
                    <td>Rp {{ $changeFee }}</td>
                </tr>
                <tr>
                    <th>Biaya Bulanan</th>
                    <td>Rp {{ number_format($membershipRequest->requestedMembership->biaya_bulanan, 0, ',', '.') }}</td>
                </tr>
                <tr>
                    <th>Tanggal Aktivasi</th>
                    <td>{{ $membershipRequest->outlet->membership_started_at->format('d F Y') }}</td>
                </tr>
                <tr>
                    <th>Jatuh Tempo</th>
                    <td>{{ $membershipRequest->outlet->membership_expires_at->format('d F Y') }}</td>
                </tr>
            </table>
