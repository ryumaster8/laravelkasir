                                        ...
                                        <div class="direct-chat-messages">
                                            ...
                                            <div class="direct-chat-msg">
                                                ...
                                                <div class="direct-chat-text">
                                                    Is this template really amazing? That's unbelievable!
                                                </div>
                                                <!-- /.direct-chat-text -->
                                            </div>
                                            <!-- /.direct-chat-msg -->
                                            ...
                                            <div class="direct-chat-msg">
                                                ...
                                                <!-- /.direct-chat-img -->
                                                <div class="direct-chat-text">
                                                    Working with AdminLTE on a great project!
                                                </div>
                                                <!-- /.direct-chat-text -->
                                            </div>
                                            <!-- /.direct-chat-msg -->
                                                ...
                                                <li>
                                                    <a href="#">
                                                        ...
                                                        <div class="contacts-list-info">
                                                            <span class="contacts-list-name">
                                                                John Travolta
                                                                <small class="contacts-list-date float-right">2/15/2023</small>
                                                            </span>
                                                            <span class="contacts-list-msg">I miss you so much...</span>
                                                        </div>
                                                        <!-- /.contacts-list-info -->
                                                    </a>
                                                </li>
                                                ...
                                                <li>
                                                    <a href="#">
                                                        ...
                                                        <div class="contacts-list-info">
                                                            <span class="contacts-list-name">
                                                                Angelina Jolie
                                                                <small class="contacts-list-date float-right">1/1/2023</small>
                                                            </span>
                                                            <span class="contacts-list-msg">Let's meet at the...</span>
                                                        </div>
                                                        <!-- /.contacts-list-info -->
                                                    </a>
                                                </li>
                                                ...
                                                <li>
                                                    <a href="#">
                                                        ...
                                                        <div class="contacts-list-info">
                                                            <span class="contacts-list-name">
                                                                Mickey Mouse
                                                                <small class="contacts-list-date float-right">12/30/2022</small>
                                                            </span>
                                                            <span class="contacts-list-msg">See you soon...</span>
                                                        </div>
                                                        <!-- /.contacts-list-info -->
                                                    </a>
                                                </li>
